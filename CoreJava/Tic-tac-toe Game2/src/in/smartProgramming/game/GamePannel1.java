...
public class GamePannel1 implements ActionListener
{
	...
	int count=0;
	String str="";
	boolean win=false, player1Win=true;
	Color color;
	
	String player1, player2, winplayer;
	
	
	GamePannel1( String player1 ,  String player2)
	{
...
//		}
	...
	void whoWins()
	{
		if (win==true)
		{
			...
			JOptionPane.showMessageDialog(jf, winplayer+" : wins");
			restartGame();
		}
