 ...
 * It's a slightly tricky question. It's a three step process. It's better visualized in code.
	...
	We can't return multiple variable in java. Since Java is Pass-by-value and these are 
	primitive data type, their values won't change. For example, below swap function will 
	not change the input integer value.
 */

public class _2_SwapNumWithoutVariable 
{
